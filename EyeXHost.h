...
public:
	...
	void Init(HWND hWnd, UINT statusChangedMessage, UINT focusedRegionChangedMessage, UINT regionActivatedMessage, UINT gazeMessage);
...
private:
	...
	void OnGazeDataEvent(TX_HANDLE hBehavior, int interactorId);
